...
class origenFixController extends Controller
{
    //
    ...
    public function eliminar(Request $rq)
    {
        try {
            ...
            return ['codigo_respuesta'=>0,'nombre'=>"Ocurrio un error inesperado al eliminar el origen\n Es posible que el error se produce al borrar un registro relacionado"];
        }
    }
}
